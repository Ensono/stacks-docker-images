...
Poetry is included in this image as a Python package dependency. Downstream projects that run Poetry inside the image should validate their workflows against Poetry 2.x, especially if they rely on older lockfile or CLI behavior.
...
| Python | pytest | 9.0.3 | https://pypi.org/project/pytest/
...
| Python | pytest-cov | 7.1.0 | https://pypi.org/project/pytest-cov
| Python | poetry | 2.3.3 | https://pypi.org/project/poetry
