:version_envsubst: 1.4.3
:version_ghcli: 2.92.0
:version_helm: 3.20.0
:version_jq: 1.8.1
:version_kluctl: 2.27.0
:version_kubectl: 1.34.7
:version_kustomize: 5.8.1
:version_tenv: 4.12.2
:version_terraform_110: 1.10.4
:version_terraform_111: 1.11.4
:version_terraform_114: 1.14.0
:version_tflint: 0.62.0
:version_terraform_docs: 0.24.0
...
| Binary | Kluctl | {version_kluctl} | https://github.com/kluctl/kluctl/releases/download/{version_kluctl}/kluctl_{version_kluctl}_linux_amd64.tar.gz | https://github.com/kluctl/kluctl/releases/download/{version_kluctl}/kluctl_{version_kluctl}_linux_arm64.tar.gz
...
| Binary | Terraform | {version_terraform_110}
{version_terraform_111}
{version_terraform_114} |
https://releases.hashicorp.com/terraform/{version_terraform_110}/terraform_{version_terraform_110}_linux_amd64.zip
https://releases.hashicorp.com/terraform/{version_terraform_111}/terraform_{version_terraform_111}_linux_amd64.zip
https://releases.hashicorp.com/terraform/{version_terraform_114}/terraform_{version_terraform_114}_linux_amd64.zip |
https://releases.hashicorp.com/terraform/{version_terraform_110}/terraform_{version_terraform_110}_linux_arm64.zip
https://releases.hashicorp.com/terraform/{version_terraform_111}/terraform_{version_terraform_111}_linux_arm64.zip
https://releases.hashicorp.com/terraform/{version_terraform_114}/terraform_{version_terraform_114}_linux_arm64.zip
...
| Binary | TFLint | {version_tflint} | https://github.com/terraform-linters/tflint/releases/download/v{version_tflint}/tflint_linux_amd64.zip |
https://github.com/terraform-linters/tflint/releases/download/v{version_tflint}/tflint_linux_arm64.zip
| PS Module | Az | 15.6.0 2+| -
| PS Module | Arm-ttk | 20260213 2+| -
| PS Module | Pester | 5.7.1 2+| -
| PS Module | PowerShell-Yaml | 0.4.12 2+| -
| PS Module | PSScriptAnalyzer 2+| 1.25.0 2+| -
|====

Three versions of Terraform are installed. This is to support migration of Terraform from one version to another. Version `1.14.0` is configured as the default version, using a symlink to the `/usr/local/terraform/1.14.0/bin` directory.
