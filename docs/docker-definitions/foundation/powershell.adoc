...
| Binary | PowerShell | 7.5.6 | https://github.com/PowerShell/PowerShell
| Module | EnsonoBuild | 1.2.35 | https://github.com/Ensono/independent-runner
| Binary | Eirctl | 0.10.1 | https://github.com/Ensono/eirctl
|====
